  ...
  groups: [
    {
      ...
      items:[
        ...
        { name:'Quantitative evidence: compute, do not eyeball',
          body:'<ol><li>Read the axis labels and units first, "in thousands" and "percent of" change everything.</li><li>Claims about a <em>relationship</em> need two data points that move in opposite directions. A single number can never establish a trend.</li><li>Claims with <strong>most, largest, steepest</strong> require arithmetic on every group before you can choose. Ties are a common trap.</li><li>Check that the choice states data <em>and</em> connects it to the claim. Accurate but irrelevant is the most common wrong answer.</li></ol>' },
    ...
    },
    {
      ...
      items:[
        { name:'Transitions: name the relationship before you read the choices',
          body:'<p>Cover the choices and decide which of four relationships holds: same direction, opposite direction, cause and effect, or example.</p><ol><li>Same direction: also, moreover, indeed, in addition, similarly.</li><li>Opposite: however, nevertheless, still. That said, on the other hand.</li><li>Cause/result: therefore, consequently, as a result, for this reason.</li><li>Example/restatement: for instance, in other words. That is.</li></ol><p><strong>Two hard distinctions:</strong> "however" reverses a claim about the <em>same</em> subject, while "by contrast" sets <em>two different</em> subjects against each other. And "in other words" requires genuine restatement, if the second sentence adds a limitation, you need "that said" instead.</p>' },
